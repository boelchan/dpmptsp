        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <x-form :action="route('instansi.update', [$instansi->id, 'uuid' => $instansi->uuid])" method="PATCH" enctype="multipart/form-data">
                            <div class="row">
                                @bind($instansi)
                                    <div class="col-md-4">
                                        <div class="form-group mb-2">
                                            <label for="" class="fw-bold d-block">Logo</label>
                                            <img id="output" src="{{ $instansi->icon_url }}" class="img-fluid rounded">
                                        ...
                                        <x-form-input name="nama" label="Nama Instansi" />
